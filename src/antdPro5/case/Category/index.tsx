...
const MovieCategory: React.FC<PageProps> = (props) => {
  ...
  const columns: ColumsType<object> = [
    {
      title: '序号',
      width: 80,
      align: 'center',
    ...
    },
    {
      ...
      render: (row: any) => {
         return (
           <img style={{height: '60px', width: '60px'}} src={resetImgUrl(row.coverImage)} alt="img" onClick={() => { dispatch!({
    ...
    },
    {
      ...
      render: (row: any) => {
          return <><Button
            ...
            type="primary" size="small" icon={ <EditOutlined /> }></Button></>
      }
    }
  ]
  return (
